...
def main():
  ...
  CFBundleGetInfoString = FullVersionStr + ", Copyright Riccardo, " + str(today.year)
  CFBundleVersion = FullVersionStr
  
  print "update_version.py - setting version to " + FullVersionStr
  print "Updating plist version info..."
  
  plistpath = scriptpath + "/resources/VirtualTubeDelay-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/VirtualTubeDelay-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/VirtualTubeDelay-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/VirtualTubeDelay-OSXAPP-Info.plist"
  ...
  plistpath = scriptpath + "/resources/VirtualTubeDelay-RTAS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/VirtualTubeDelay-AAX-Info.plist"
...
#   plistpath = scriptpath + "/resources/VirtualTubeDelay-IOSAPP-Info.plist"
...
#   replacestrs(plistpath, "//Apple//", "//Apple Computer//");
  ...
  plistpath = scriptpath + "/installer/VirtualTubeDelay.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/VirtualTubeDelay.iss",inplace=1):
